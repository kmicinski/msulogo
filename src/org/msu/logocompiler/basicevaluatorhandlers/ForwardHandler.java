...
public class ForwardHandler implements EvaluatorFunctionHandler {
	public void evaluateFunction(FunCallExpressionAST function,
		...
		if (t.getBaseType() != BaseTypes.Integer) {
			System.err.println("Error: trying to ``forward'' a non-integer, bad job... " 
					+ function.getStartToken());
			return;
		}
		
		environment.getActiveTurtle().turtleForward(
